...
$mysqli_query = "SELECT `Temperature`, `Humidity`, `Wind speed`, `Wind direction`, `Rainfall`, `Time stamp` FROM WeatherStation WHERE `Time stamp` > DATE_SUB(NOW(), INTERVAL 7 DAY)";
