...
$mysqli_query = "SELECT `Status`, `Set temperature`, `Current temperature`, `Temperature range`, `Setpoint source`, `Time stamp` FROM GasBoilerController WHERE `Time stamp` > DATE_SUB(NOW(), INTERVAL 7 DAY)";
